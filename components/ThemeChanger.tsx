...
const CATEGORIES = ["All", "Real Estate", "Modern", "Neo Brutalism", "Glassmorphism", "Retro Gaming", "Cyberpunk", "Special"];
...
export function ThemeChanger({ className }: { className?: string }) {
    ...
    const applyPreset = (presetConfig: Record<string, string>, dataTheme: string, presetName: string) => {
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-6">
                        <div className="space-y-2">
                            <h3 className="font-bold uppercase text-xs opacity-70">Category</h3>
                            <CustomSelect
                                ...
                                options={CATEGORIES.map(cat => ({
                                    value: cat,
                                    label: cat,
                                    color: cat === "All" ? undefined : 
                                           cat === "Real Estate" ? "#d4af37" :
                                           cat === "Modern" ? "#6366f1" :
                                           cat === "Neo Brutalism" ? "#FF4D00" :
                                           cat === "Glassmorphism" ? "#818cf8" :
                                           cat === "Retro Gaming" ? "#ff6e96" :
                                           cat === "Cyberpunk" ? "#00ff41" : "#22c55e"
                                }))}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            {filteredPresets.slice(0, 9).map((preset) => (
                                <button
                                    key={preset.name}
                                    onClick={() => applyPreset(preset.config, preset.dataTheme, preset.name)}
